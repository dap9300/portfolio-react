        ...
        <Card className="p-6 mt-4 bg-background">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              <h3 className="font-semibold text-lg flex items-start gap-2 text-foreground">
                <FileChartColumnIncreasing className="w-5 h-5 text-primary shrink-0 mt-0.5" />
                <span className="leading-tight">{project.detailedSections.overview.metricsTitle[language]}</span>
              </h3>
            ...
            <div className="space-y-4">
              <h3 className="font-semibold text-lg flex items-start gap-2 text-foreground">
                ...
                <span className="leading-tight">{project.detailedSections.overview.followersTitle[language]}</span>
              </h3>
          ...
          <div className="mt-8">
            <h3 className="text-lg font-semibold flex items-center gap-2 text-foreground mb-4 pl-0 md:pl-0">
              <GalleryHorizontalEnd className="w-5 h-5 text-primary shrink-0 mt-0.5" />
              <span className="leading-tight">{project.detailedSections.socialMediaContent.title[language]}</span>
            </h3>
