...
// Progetti con sito web esterno
const EXTERNAL_WEBSITE_PROJECTS = {
  '3': 'https://www.manunta.it/' // manunta
};
...
// Utility che controlla se un progetto ha un sito web esterno
export function hasExternalWebsite(id: string): boolean {
  return !!EXTERNAL_WEBSITE_PROJECTS[id];
}

// Utility che restituisce l'URL del sito web esterno di un progetto
export function getExternalWebsiteUrl(id: string): string | null {
  return EXTERNAL_WEBSITE_PROJECTS[id] || null;
}
